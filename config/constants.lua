...
MONSTER_GHOST_LIGHT_RATE = 2;
MONSTER_GHOST_LIGHT_SENSE_DISTANCE = 350;
MONSTER_GHOST_MOVEMENT_SENSE_DISTANCE = 75;
MONSTER_GHOST_WALK_SPEED = 150;
MONSTER_GHOST_CHASE_SPEED = 300;
MONSTER_GHOST_HUNT_CHANCE = 20;
