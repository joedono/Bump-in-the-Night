...
PLAYER_MIND_SANE_TIMER = 30;
PLAYER_MIND_MUDDLE_BUILDUP = PLAYER_MIND_MUDDLE_TIMER / 5;
...
MONSTER_ALIEN_RAY_GUN_SPEED = 200;
MONSTER_ALIEN_RAY_GUN_EXPLODE_TIME = 3;

MONSTER_ZOMBIE_WIDTH = 32 * MONSTER_SCALE;
MONSTER_ZOMBIE_HEIGHT = 32 * MONSTER_SCALE;
MONSTER_ZOMBIE_SIGHT_DISTANCE = 450;
MONSTER_ZOMBIE_SIGHT_CONE  = math.pi * 1/4;
MONSTER_ZOMBIE_WALK_SPEED = 150;
MONSTER_ZOMBIE_TURN_SPEED = 3;
MONSTER_ZOMBIE_STUN_TIMER = 5;
MONSTER_ZOMBIE_BURN_TIMER = 10;
...
SHOVEL_DIG_SCALE = 1;
SHOVEL_DIG_WIDTH = 32 * SHOVEL_DIG_SCALE;
SHOVEL_DIG_HEIGHT = 32 * SHOVEL_DIG_SCALE;
